...
import jwtAuthReducer from './jwt-auth-reducer'
import JWTAuthUsers from './jwt-auth-users'
import JWTAuthProfile from './jwt-auth-profile'
...
export {jwtAuthReducer, JWTAuthInterceptor, JWTAuthService, JWTAuthUsers, JWTAuthProfile};